...
class ChessBoard:
    ...
    board[7, 7] = Rook("w", (7, 7), piece_size, np.zeros(15))
    board[7, 0] = Rook("w", (7, 0), piece_size, np.zeros(15))
    board[7, 2] = Bishop("w", (7, 2), piece_size, np.zeros(15))
    board[7, 5] = Bishop("w", (7, 5), piece_size, np.zeros(15))
    board[7, 6] = Knight("w", (7, 6), piece_size, np.zeros(8))
    board[7, 1] = Knight("w", (7, 1), piece_size, np.zeros(8))
    board[6, 1] = Pawn("w", (6, 1), piece_size, np.zeros(6))
    board[6, 2] = Pawn("w", (6, 2), piece_size, np.zeros(6))
    board[6, 3] = Pawn("w", (6, 3), piece_size, np.zeros(6))
    board[6, 4] = Pawn("w", (6, 4), piece_size, np.zeros(6))
    board[6, 5] = Pawn("w", (6, 5), piece_size, np.zeros(6))
    board[6, 6] = Pawn("w", (6, 6), piece_size, np.zeros(6))
    board[6, 7] = Pawn("w", (6, 7), piece_size, np.zeros(6))
    board[6, 0] = Pawn("w", (6, 0), piece_size, np.zeros(6))

    board[0, 4] = King("b", (0, 4), piece_size, np.zeros(8))
    board[0, 3] = Queen("b", (0, 3), piece_size, np.zeros(30))
    board[0, 0] = Rook("b", (0, 0), piece_size, np.zeros(15))
    board[0, 7] = Rook("b", (0, 7), piece_size, np.zeros(15))
    board[0, 2] = Bishop("b", (0, 2), piece_size, np.zeros(15))
    board[0, 5] = Bishop("b", (0, 5), piece_size, np.zeros(15))
    board[0, 6] = Knight("b", (0, 6), piece_size, np.zeros(8))
    board[0, 1] = Knight("b", (0, 1), piece_size, np.zeros(8))
    board[1, 1] = Pawn("b", (1, 1), piece_size, np.zeros(6))
    board[1, 2] = Pawn("b", (1, 2), piece_size, np.zeros(6))
    board[1, 3] = Pawn("b", (1, 3), piece_size, np.zeros(6))
    board[1, 4] = Pawn("b", (1, 4), piece_size, np.zeros(6))
    board[1, 5] = Pawn("b", (1, 5), piece_size, np.zeros(6))
    board[1, 6] = Pawn("b", (1, 6), piece_size, np.zeros(6))
    board[1, 7] = Pawn("b", (1, 7), piece_size, np.zeros(6))
    board[1, 0] = Pawn("b", (1, 0), piece_size, np.zeros(6))
