...
def game_chess():
    ...
    while True:
        ...
        MULTIPLAYED_BUTTON = Button(image=pygame.image.load("assets/Options Rect.png"), pos=(640, 200), 
                                    text_input="MULTIPLAYER", font=get_font(50), base_color="Black", hovering_color="WHITE")
        ...
        for button in [BACK_BUTTON, QUIT_BUTTON, MULTIPLAYED_BUTTON, SINGLEPLAYER_BUTTON]:
